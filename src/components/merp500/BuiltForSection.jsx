    ...
    <section className="bg-[#FCF7FB] py-[50px] pl-[131px] pr-[105px] xl:px-12 md:py-[40px] md:px-[16px]">
      <div className="max-w-[1240px] mx-auto flex flex-row items-start justify-between gap-[57px] lg:flex-col lg:gap-[40px]">
        ...
        >
          ...
          <h2 className="font-archivo text-[40px] md:text-[32px] font-semibold text-[#010101] leading-[56px] md:leading-[1.05] tracking-[-0.03em] capitalize">
        ...
        >
          {AUDIENCE_CARDS.map((card) => (
            ...
            >
              <span className="font-archivo text-[22px] font-semibold text-[#000000] opacity-40 leading-[16px] tracking-[0.01em] shrink-0 mt-0.5 lowercase">
                {card.num}
              </span>
              <div className="flex flex-col gap-[8px]">
                <h3 className="font-archivo text-[16px] font-semibold text-[#000000] leading-[16px] tracking-[0.01em]">
                  {card.title}
                </h3>
                <p className="font-geist text-[16px] font-normal text-[#000000] opacity-40 leading-[20px] md:leading-[1.25] tracking-[0.01em]">
                  {card.desc}
                </p>
              </div>
            </motion.div>

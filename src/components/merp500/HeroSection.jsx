  ...
  return (
    <section className="relative bg-[#0F0E0F] min-h-[797px] flex items-center overflow-hidden xl:px-8 py-[120px] px-[102px] pb-[80px] md:px-[16px] md:pb-[60px] md:pt-[120px]">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto w-full flex items-center justify-center  gap-[101px] lg:flex-col lg:gap-[40px]">
        ...
        {/* Left — Hero container */}
        <div className="flex flex-col gap-8 md:gap-10 w-[541px] xl:w-[480px] lg:w-full md:w-full md:max-w-full shrink-0 relative z-20">
          
          {/* Hero text frame */}
          <div className="flex flex-col gap-[16px]">
            <div className="relative inline-block w-full mt-4 md:mt-0">
              {/* Figma: "You" icon placed above 500 Future text */}
              <div className="absolute left-[280px] top-[45px] md:left-auto md:right-[53px] md:top-[190px] md:-rotate-[7.5deg] pointer-events-none z-10 w-[72px] h-[58px]">
                <Image
            ...
            <p className="font-geist text-[16px] font-normal text-white/40 max-w-[455px] md:w-full md:max-w-full leading-[24px] tracking-[0.01em]">
          ...
          {/* Button + text frame */}
          <div className="flex flex-col gap-4 md:gap-[32px] w-[473px] md:w-full md:max-w-full">
        ...
        {/* Right — Image frame */}
        <div className="relative shrink-0 w-full max-w-[641px] aspect-[541/597] xl:max-w-[440px] lg:max-w-full lg:aspect-video md:aspect-square md:hidden">
          <Image

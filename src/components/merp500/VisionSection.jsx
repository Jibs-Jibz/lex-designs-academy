...
const VisionSection = () => {
  return (
    <section className="bg-[#060505] dark:bg-[#060505] px-16 xl:px-8 md:px-5 py-24 md:py-16">
      <div className="max-w-[1240px] mx-auto flex gap-12 xl:gap-8 lg:flex-col lg:items-start items-center justify-between">
        ...
        >
          <p className="font-geist text-[18px] md:text-[16px] font-semibold text-white/70 leading-[1.6] max-w-[605px]">

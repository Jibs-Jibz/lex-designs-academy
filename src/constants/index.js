...
export const DIGITALARTSDATA = [
  {
    ...
    courseContent: [
      ...
      },
      {
        ...
        data: ["Additive vs.subtractive light", "How a pixel gets its color"],
      },
      {
        title: "Unit 5 - Portraits ",
        data: ["Geometric image from photograph", "Activist art compositions "],
      },
      {
        title: " Unit 6 - Portfolio evaluation ",
        data: ["Presentation to clients", "Positioning in the Art industry"],
      },
      //  {
      //     title: " ",
      //     data: [
